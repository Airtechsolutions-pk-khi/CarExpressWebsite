...
public partial class db_entities : DbContext
{
    ...
    [DbFunction("db_entities", "SplitString")]
    public virtual IQueryable<SplitString_Result> SplitString(string input, string character)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SplitString_Result>("[db_entities].[SplitString](@Input, @Character)", inputParameter, characterParameter);
    }


    [DbFunction("db_entities", "SplitStringGroup")]
    public virtual IQueryable<SplitStringGroup_Result> SplitStringGroup(string groupIDS, string priortyIDS, string minutesIDS, string attemptIDS, Nullable<double> offsetval)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SplitStringGroup_Result>("[db_entities].[SplitStringGroup](@GroupIDS, @PriortyIDS, @MinutesIDS, @AttemptIDS, @Offsetval)", groupIDSParameter, priortyIDSParameter, minutesIDSParameter, attemptIDSParameter, offsetvalParameter);
    }
